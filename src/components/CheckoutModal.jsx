...
const planData = {
  ...
  max: {
    label: 'Max',
    sub: 'For the practice of being well, deeply.',
    price: 13,
    crossedPrice: 20,
    period: 'month',
    color: '#9B4423',
    bullets: [
      'Everything in Pro',
      'Custom seasonal meal plan — RD-built, refreshed quarterly',
      'Custom 12-week training cycle — written by a certified PT',
      'Four family seats',
      'Quill AI assistant — knows your full history',
