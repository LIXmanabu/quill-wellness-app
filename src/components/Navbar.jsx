...
export default function Navbar({ activePage, onNavigate }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-shadow duration-300 bg-cream ${scrolled ? 'border-b border-ink/15 shadow-soft' : 'border-b border-ink/10'}`}>
      {/* Editorial top strip */}
