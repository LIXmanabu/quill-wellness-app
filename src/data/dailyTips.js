...
// Each tip carries an Unsplash photo URL (curated, kept small via auto-format params).
...
export const dailyTips = [
  ...
  { id: 't8', category: 'hydration', icon: '🍋', title: 'Flavour your water', body: 'Lemon, cucumber, or mint make plain water far easier to drink consistently. Hydration > willpower.', img: U('1582731593735-c87c0b69bd5b') },
  ...
  { id: 't10', category: 'movement', icon: '💪', title: 'Two minutes of stretching', body: 'Shoulder rolls + neck circles + cat-cow before screens fight tension headaches before they start.', img: U('1518611012118-696072aa579a') },
  ...
  { id: 't12', category: 'skincare', icon: '🧴', title: 'Less is more', body: 'A 3-step routine (cleanse, moisturize, SPF) done daily beats a 10-step routine done occasionally.', img: U('1570194065650-d99fb4bedf0a') },
  ...
  { id: 't18', category: 'mood', icon: '🎵', title: 'One song dance break', body: 'A 3-minute dance to a song you love is mood-tested medicine. Move alone if you must.', img: U('1511671782779-c97d3d27a1d4') },
  { id: 't19', category: 'skincare', icon: '💧', title: 'Moisturize damp skin', body: 'Apply moisturizer within 60 seconds of washing — it locks in 10x more water than dry-skin application.', img: U('1570194065650-d99fb4bedf0a') },
  ...
  { id: 't21', category: 'mindset', icon: '⏸️', title: 'The 5-minute pause', body: 'Before reacting to a stressful message, wait 5 minutes. Most regretted replies happen in the first 60 seconds.', img: U('1499209974431-9dddcece7f88') },
  { id: 't22', category: 'hydration', icon: '🚰', title: 'Bottle on your desk', body: 'Visible water = drunk water. Out-of-sight bottles are forgotten bottles.', img: U('1559839734-2b71ea197ec2') },
  { id: 't23', category: 'sleep', icon: '🌡️', title: 'Cool room, warm feet', body: 'Bedroom around 18°C with socks on falls asleep fastest. Cool core + warm extremities is the sweet spot.', img: U('1505693416388-ac5ce068fe85') },
  ...
  { id: 't25', category: 'mood', icon: '💌', title: 'Send a thank-you', body: 'Text one person something specific you appreciate about them. Boosts your mood as much as theirs.', img: U('1517842645767-c639042777db') },
  ...
  { id: 't28', category: 'mindset', icon: '🎯', title: 'One thing only', body: 'Pick the single most important task tomorrow before bed. Decision fatigue eats willpower in the morning.', img: U('1517842645767-c639042777db') },
  ...
  { id: 't31', category: 'movement', icon: '🤸', title: 'Dynamic warm-up', body: 'Skip static stretching pre-workout. Leg swings, arm circles, and walking lunges prepare muscles better and prevent injury.', img: U('1518611012118-696072aa579a') },
  { id: 't32', category: 'mood', icon: '😊', title: 'Smile on purpose', body: 'Forcing a smile for 30 seconds genuinely triggers a small dopamine release — facial-feedback hypothesis at work.', img: U('1490750967868-88aa4486c946') },
  { id: 't33', category: 'skincare', icon: '🧖', title: 'Pillow case rotation', body: 'Swap pillow cases every 2-3 days to reduce bacteria, oil, and breakout risk on cheek/jaw areas.', img: U('1505693416388-ac5ce068fe85') },
  ...
  { id: 't35', category: 'mindset', icon: '🧠', title: 'Single-task for 25 min', body: 'A Pomodoro of one task (no tabs, no phone) gets more done than 2 hours of half-attention multi-tasking.', img: U('1499209974431-9dddcece7f88') },
  ...
  { id: 't37', category: 'sleep', icon: '🎧', title: 'White noise trick', body: 'A fan, rain sounds, or pink noise masks micro-wakeups and improves sleep quality on noisy nights.', img: U('1505693416388-ac5ce068fe85') },
  { id: 't38', category: 'movement', icon: '🦵', title: 'Glute bridges daily', body: 'Sitting all day shuts off your glutes. 20 bridges in the morning re-wakes them and protects your lower back.', img: U('1518611012118-696072aa579a') },
  ...
  { id: 't40', category: 'skincare', icon: '🧊', title: 'Cold rinse on puffy days', body: 'Splash cold water on your face for 30 seconds in the morning to reduce overnight puffiness fast.', img: U('1556228720-195a672e8a03') },
  { id: 't41', category: 'nutrition', icon: '🌶️', title: 'Spice it up', body: 'Turmeric, ginger, cinnamon, garlic — all anti-inflammatory and add zero calories. Cooking with them daily adds up.', img: U('1599909533730-7ca47e9c6c01') },
  { id: 't42', category: 'mindset', icon: '✏️', title: 'Brain dump on paper', body: 'When overwhelmed, write everything in your head on paper for 5 minutes. Almost always reduces the load by half.', img: U('1517842645767-c639042777db') },
  { id: 't43', category: 'hydration', icon: '⚡', title: 'Pinch of salt in water', body: 'After hard exercise, a pinch of salt + lemon in water rehydrates better than plain water (electrolytes).', img: U('1582731593735-c87c0b69bd5b') },
  { id: 't44', category: 'sleep', icon: '🕯️', title: 'Wind-down ritual', body: 'A repeated 20-minute pre-bed routine (tea, book, dim lights) signals "sleep mode" to your brain.', img: U('1519710164239-da123dc03ef4') },
  ...
  { id: 't47', category: 'skincare', icon: '🌃', title: 'Never sleep in makeup', body: 'Sleeping in makeup clogs pores all night and is linked to faster skin ageing. Even a wipe is better than nothing.', img: U('1522335789203-aaa2113c647b') },
  ...
  { id: 't49', category: 'mindset', icon: '🌱', title: 'Yet — add that word', body: '"I can\'t do this" → "I can\'t do this yet". One word, big mindset shift (Dweck — growth mindset).', img: U('1542736667-069246bdbc6d') },
  { id: 't50', category: 'hydration', icon: '🥤', title: 'Cut one sugary drink', body: 'Replacing one soda or juice per day with water saves ~150 kcal and 35g sugar daily — easiest health win.', img: U('1559839734-2b71ea197ec2') },
  { id: 't51', category: 'sleep', icon: '☕', title: 'Caffeine curfew', body: 'No caffeine after 2 pm. Half-life is ~6 hours — afternoon coffee still affects 10 pm sleep quality.', img: U('1495474472287-4d71bcdd2085') },
  { id: 't52', category: 'movement', icon: '🧗', title: 'Hang from a bar', body: '30 seconds of dead-hang daily improves grip, shoulder mobility, and decompresses the spine.', img: U('1526506118085-60ce8714f8c5') },
  ...
  { id: 't54', category: 'skincare', icon: '🌸', title: 'Niacinamide is gentle', body: 'For redness, large pores, and oil control — niacinamide 5% is the most-tolerated active in skincare.', img: U('1556228453-efd6c1ff04f6') },
  ...
  { id: 't57', category: 'hydration', icon: '🌡️', title: 'Check your pee', body: 'Pale straw = hydrated. Dark yellow = drink more. Clear = you might be overdoing it.', img: U('1548839140-29a749e1cf4d') },
  { id: 't58', category: 'sleep', icon: '🧦', title: 'No screens in bed', body: 'Bed = sleep + intimacy only. Using bed for scrolling weakens the sleep association over time.', img: U('1505693416388-ac5ce068fe85') },
  { id: 't59', category: 'movement', icon: '🧘', title: 'Spinal twist before bed', body: 'Lying supine spinal twist for 1 minute per side decompresses the back and signals relaxation.', img: U('1518611012118-696072aa579a') },
  { id: 't60', category: 'mindset', icon: '🌟', title: 'Celebrate small wins', body: 'Finished a workout? Drank water? Said no to something draining? Out-loud acknowledgement rewires reward pathways.', img: U('1470770841072-f978cf4d019e') },
]
